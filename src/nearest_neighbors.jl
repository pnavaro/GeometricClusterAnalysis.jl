...
"""
function nearest_neighbors!(dists :: Vector{Float64}, idxs :: Vector{Int64}, k :: Int, points :: Array{Float64,2}, μ :: Vector{Float64}, Σ :: Matrix{Float64}; inverted = false)

    if inverted
        for (i, x) in enumerate(eachcol(points))
