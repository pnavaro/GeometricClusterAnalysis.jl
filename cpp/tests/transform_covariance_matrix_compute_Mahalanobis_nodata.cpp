...
int main(int argc, char** argv){
	...
	Matrix<double,d,d> cov;
	cov << 34, 0, 6, 0, 1, 2, 6, 2, 8;
...
// Eigenvalues
	...
	std::cout<< S.get_eigenvalues_initial() <<std::endl;
...
// Inverse of the eigenvalues
	...
	std::cout<< S.get_eigenvalues_inverted_initial() <<std::endl;
...
// Product
	std::cout<< "Note that the product of these two matrices is the identity matrix :"<< std::endl;
	std::cout<< S.return_inverse_matrix_initial()*S.return_matrix_initial()<< std::endl;

	std::cout<< std::endl;
	std::cout<< std::endl;

// Modification of the eigenvalues : 
	size_t d_intrinsic = 2; // 2 eigenvalues are different, the 4 smallest eigenvalues are all equal.
	...
	std::cout<< S.get_eigenvalues_to_use() <<std::endl;
	std::cout<<"The inverse of the eigenvalues are :"<<std::endl; 
	std::cout<< S.get_eigenvalues_inverted_to_use() <<std::endl;
...
// Finally, we compute the Mahalanobis squared norm of some vector :
	Matrix<double,1,d> m;
	m << 4,5,6 ;
	std::cout<<"The Mahalanobis squared norm of the vector m = "<<m<<" :"<<std::endl;
	std::cout << S.mahalanobis_distance(m) << std::endl;
