                      ...
                      if u <= threshold[6]
                        ...
                        if u <= threshold[7]
                          ...
                          if u <= threshold[8]
                            ...
                            if u <= threshold[9]
                              c[i] = 9
                              x[1, i] += v * cos(4 * π/7) + (1 - v) * cos(6π/7)
                              x[2, i] += v * sin(4 * π/7) + (1 - v) * sin(6π/7)
                            else
                              if u <= threshold[10]
                                c[i] = 10
                                x[1, i] += v * cos(6π/7) + (1 - v) * cos(8π/7)
                                x[2, i] += v * sin(6π/7) + (1 - v) * sin(8π/7)
                              else
                                if u <= threshold[11]
                                  c[i] = 11
                                  x[1, i] += v * cos(8π/7) + (1 - v) * cos(10π/7)
                                  x[2, i] += v * sin(8π/7) + (1 - v) * sin(10π/7)
                                else
                                  if u <= threshold[12]
                                    c[i] = 12
                                    x[1, i] += v * cos(10π/7) + (1 - v) * cos(12π/7)
                                    x[2, i] += v * sin(10π/7) + (1 - v) * sin(12π/7)
                                  else
                                    if u <= threshold[13]
                                      c[i] = 13
                                      x[1, i] += v * cos(12π/7) + (1 - v) * cos(14π/7)
                                      x[2, i] += v * sin(12π/7) + (1 - v) * sin(14π/7)
                                    else
                                      c[i] = 14
                                      x[1, i] += v * cos(14π/7) + (1 - v) * cos(2π/7)
                                      x[2, i] += v * sin(14π/7) + (1 - v) * sin(2π/7)
                                    end
                                  end
                                end
                              end
